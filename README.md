<div align="center">
  ...
  <!-- PORTADA PRINCIPAL -->
  <img src="https://i.postimg.cc/DZBkRVjx/1756434414.png" alt="Portada BerMatModZ" width="100%" style="border-radius: 10px; border: 3px solid #075E54; box-shadow: 0 0 15px rgba(0, 255, 170, 0.3);"/>
  ...
  <!-- GIF + MENSAJE DE BIENVENIDA -->
  <p>
    <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="50"/>
    <strong>Bienvenid@ a mi mundo de desarrollo, ciberseguridad y tecnología</strong>
  </p>

  <!-- INFO RÁPIDA EN ESTILO TERMINAL -->
  <div style="background: #0e0e0e; color: #00ffaa; padding: 15px; border-radius: 8px; font-family: 'Courier New', monospace; font-size: 14px; width: 90%; max-width: 700px; border: 1px solid #00ffaa;">
    <strong>╔════════════════════════════════╗</strong><br>
    🧠 <strong>Desarrollador & Programador</strong> | 100% autodidacta<br>
    🛠️ <strong>Proyectos:</strong> Bots, Webs, Hacking ético<br>
    🧰 <strong>Herramientas:</strong> Termux, AIDE, GitHub, APIs, JS, Python<br>
    🖥️ <strong>Lenguajes:</strong> Java, JS, Python, HTML, CSS, Bash<br>
...
<!-- CONTADOR DE VISITAS -->
<div align="center">
  <img src="https://profile-counter.glitch.me/BerMatMods/count.svg" alt="Contador de visitas" style="width: 300px; border-radius: 8px; margin: 10px;"/>
</div>

---

<!-- WHATSAPP INFO (basado en el contenido del enlace) -->
